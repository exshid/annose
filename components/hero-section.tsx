...
<p data-aos="fade-up" data-aos-once="true" data-aos-offset="200" className="jakarta-font mb-5 lg:mb-10 text-darkish dark:text-white p-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
