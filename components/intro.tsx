...
<div data-aos="zoom-out" data-aos-once="true" className="flex-col w-full md:w-2/6 hidden md:flex justify-center p-6 xl:px-12 dark:text-gray-100">
<Image
  src={placeholder}
...
<div className="flex flex-col w-full md:w-2/4 justify-center p-6 xl:px-12 dark:text-gray-100">
<p className="jakarta-font text-xs lg:text-xl mb-10 text-darkish dark:text-white">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quae, ad asperiores ipsam voluptatem rem a id maxime odio ullam accusantium dolor magnam quam expedita! A tenetur ipsam enim magnam cupiditate.
