...
>
            ...
            <div className="bottom-0 absolute p-4 text-center inset-x-0 flex justify-center space-x-4">
                <span>
        ...
        backgroundColor: '#161616'}}>
            <div className="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center" style={{
        backgroundImage: `url("https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80")`
      }}
>
                <div className="absolute bg-black opacity-60 inset-0 z-0"></div>
