         ...
         <p  data-aos="fade-up" data-aos-once="true" className="text-3xl my-4 text-darkish dark:text-white">
              CONTACT FORM
                ...
                <form data-aos="fade-up" data-aos-once="true" action="" className="sm:w-2/3 lg:w-full w-full px-4 lg:px-4 xl:px-0 mx-auto">
                    ...
                    <div className="pb-2 pt-4">
                        <textarea className="contact-placeholder bg-white block w-full p-4 text-lg border min-h-[151px] dark:border-white rounded-sm dark:bg-darkish" type="text" name="message" id="message" placeholder="Your message..." />
                    </div>
