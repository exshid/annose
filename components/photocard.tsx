...
import { HeroSection } from '@/components/hero-section';
  ...
  export function PhotoCard() {
    ...
    <HeroSection/>
<div className='h-auto lg:h-full w-3/5 lg:w-2/4 xl:w-2/5 flex clip-custom justify-center bg-gradient-to-r from-emerald-400 to-cyan-400 mt-5 lg:mt-0 pt-5'>
    <Image 
          src={placeholder}
