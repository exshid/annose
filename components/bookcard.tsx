...
type BookCardProps = {
  ...
  export function BookCard() {
    ...
    return (
      ...
      <Image src={covers[count]} alt="cover of the book" className="w-auto h-auto rounded-lg lg:rounded-none transition duration-500 delay-500 ease-in-out object-cover contain lg:w-[555px] lg:h-full"/>
