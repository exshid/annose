    ...
    return (
      <div className="z-30 relative items-center justify-center w-full h-full md:overflow-auto">
          ...
          <div className="absolute inset-0 z-30  flex flex-col items-center justify-center backdrop-blur">
              <div className="shadow-2xl flex-col md:flex-row rounded-lg md:overflow-hidden	flex w-full h-full md:w-[840px] md:h-[555px] bg-cover bg-center">
      <Image src={cover} alt="cover of the book" className="w-3/4 h-full md:w-[555px] md:h-[355px]"/>
<div className="h-full flex-col justify-evenly w-full md:w-max p-5 flex text-white bg-gradient-to-r from-emerald-400 to-cyan-400"><h3 className="font-inter font-black text-5xl">Book Title</h3><p className="jakarta-font">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dignissimos nihil fugit distinctio ut nemo corrupti. Aperiam, distinctio a obcaecati dolore ipsum, harum minus facere deleniti ullam cumque officiis ea minima!</p>
<div>
