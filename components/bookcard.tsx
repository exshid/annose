    ...
    return (
      <div className="z-30 relative items-center justify-center w-full h-full md:overflow-auto">
          ...
          <div className="absolute inset-0 z-30  flex flex-col items-center justify-center backdrop-blur">
              <div className="shadow-2xl flex-col rounded-lg md:overflow-hidden	flex w-full h-full md:w-[840px] md:h-[555px] bg-cover bg-center">
      <Image src={cover} alt="cover of the book" className="w-3/4 md:w-[555px] md:h-[355px]"/>
