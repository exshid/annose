...
type BookCardProps = {
 ...
 <Image 
    ...
    <div className="absolute bg-white dark:bg-lightdarkish h-1/6 w-full bottom-0 hover:opacity-0 transition"><h3 className="flex justify-center items-center	text-lg dark:text-white">Book Name</h3></div>
    </div>
