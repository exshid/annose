...
type BookCardProps = {
  ...
  export function BookCard() {
    ...
    return (
      ...
      <Image src={cover} alt="cover of the book" className="w-[95%] h-[95%] md:w-[555px] md:h-full"/>
<div className="h-min md:h-full bottom-[17px] md:bottom-[unset] flex-col justify-evenly w-[94%] absolute md:relative md:w-max p-5 flex text-white bg-gradient-to-r from-emerald-400 to-cyan-400"><h3 className="font-inter font-black text-5xl">Book Title</h3>
