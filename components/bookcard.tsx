...
type BookCardProps = {
  ...
  export function BookCard() {
    ...
    return (
        <div className="group relative flex bg-white custom-boxshadow hover:shadow-none transition dark:shadow-none dark:bg-lightdarkish delay-500 rounded-lg h-[550px] w-[350px] justify-around items-center">
 <Image 
          src={cover}
