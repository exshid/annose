    ...
    return (
      <div className="z-30 relative items-center justify-center w-full h-auto min-h-full lg:overflow-auto">
          ...
          <div className="absolute inset-0 z-30 flex flex-col items-center justify-center backdrop-blur">
              <div data-aos="fade-right" data-aos-once="true" className="shadow-2xl z-[55] flex-col lg:flex-row rounded-lg lg:overflow-hidden items-center justify-center	flex w-4/5 h-4/5 lg:w-[840px] lg:h-[555px] bg-cover bg-center">
