  ...
  export function BookCard() {
    ...
    return (
      <div className="z-30 relative items-center justify-center w-full h-full lg:overflow-auto">
          <div className="inset-0 h-screen bg-cover transition ease-in-out bg-center bg-fixed" 
              style={{
      ...
      <Image src={covers[count]} alt="cover of the book" className="w-auto h-auto rounded-lg lg:rounded-none transition ease-in-out object-cover contain lg:w-[555px] lg:h-full"/>
