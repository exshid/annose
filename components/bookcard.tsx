...
type BookCardProps = {
 ...
 <Image 
    ...
    <div className="flex justify-center items-center absolute bg-white dark:bg-lightdarkish h-1/6 w-full bottom-0 group-hover:delay-1000 group-hover:opacity-0 transition">
