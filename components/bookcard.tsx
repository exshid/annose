...
<div className="hidden lg:block h-min lg:h-full bottom-[17px] lg:bottom-[unset] flex-col justify-evenly w-[416px] absolute lg:relative lg:w-max p-5 flex text-white bg-gradient-to-r from-emerald-400 to-cyan-400"><h3 className="font-inter font-black text-5xl">Book Title</h3>
