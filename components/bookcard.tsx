...
type BookCardProps = {
  ...
  export function BookCard() {
    ...
    const [transitionClassText, setTransitionClassText] = useState("-translate-x-[0px]");
    ...
    function classNames() {
      ...
      setTransitionClassText("-translate-x-[10px]");
      ...
      setTimeout(() => {
        setTransitionClassText("-translate-x-[0px]");
    ...
    return (
      <div className="z-30 relative items-center justify-center w-full h-auto min-h-full lg:overflow-auto">
          ...
          <div className="absolute inset-0 z-30 flex flex-col items-center justify-center backdrop-blur-md">
              <div data-aos="fade-right" data-aos-once="true" className="z-[55] flex-col lg:bg-gradient-to-r from-emerald-400 to-cyan-400 lg:flex-row rounded-lg lg:overflow-hidden items-center justify-center	flex w-11/12 h-4/5 lg:w-[840px] lg:h-[555px] bg-cover bg-center">
...
<div className="flex h-min lg:h-full bottom-[17px] lg:bottom-[unset] flex-col justify-evenly w-auto rounded-lg lg:rounded-none absolute lg:relative lg:w-3/5 p-5 text-white bg-gradient-to-r lg:bg-none from-emerald-400 to-cyan-400"><div><h3 className={`font-inter font-black text-3xl lg:text-5xl ${transitionClassText}`}>{blogConfig.books[count].title}</h3>
<p className={`jakarta-font ${transitionClassText}`}>By {blogConfig.books[count].author}</p></div>
<p className={`hidden lg:block jakarta-font !m-0 !lg:mb-[40px] ${transitionClassText}`} >
