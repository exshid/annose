...
type BookCardProps = {
  ...
  export function BookCard() {
    ...
    function classNames() {
      ...
      setTransitionClassImg("opacity-0 z-[55] shadow-2xl flex-col lg:flex-row rounded-lg lg:overflow-hidden items-center justify-center	flex w-full h-full lg:w-[840px] lg:h-[555px] bg-cover bg-center");
      ...
      setTimeout(() => {
        setTransitionClassImg("z-[55] shadow-2xl flex-col lg:flex-row rounded-lg lg:overflow-hidden items-center justify-center	flex w-full h-full lg:w-[840px] lg:h-[555px] bg-cover bg-center");
    ...
    return (
      <div className="z-30 relative items-center justify-center w-full h-full lg:overflow-auto">
          ...
          <div className="absolute inset-0 z-30 flex flex-col items-center justify-center backdrop-blur">
              <div data-aos="fade-right" data-aos-once="true" className={transitionClassImg}>
      <Image src={covers[count]} alt="cover of the book" className="w-auto h-auto rounded-lg lg:rounded-none transition opacity-100 ease-in-out object-cover contain lg:w-[555px] lg:h-full"/>
