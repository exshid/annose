...
type IntroSectionProps = {
  ...
  export function IntroSection() {
    ...
    return (
        <div className="flex flex-col h-screen w-1/2 bg-white dark:bg-lightdarkish justify-around items-center">
               <h3 className="jakarta-title text-5xl font-black uppercase bg-gradient-to-r from-rose-600 to-rose-900 bg-clip-text text-transparent">More about A. B. Cdef</h3>
