...
First, we need a dashcam video to work with. I chosse [this one](https://youtu.be/zSY1Ux7UbPU?t=3638) because it features multiple lane changes, both left and right. A frame from the video looks like this:
