...
<div className="w-full h-full py-2 self-start"><h2 className="inline-block text-2xl md:text-3xl lg:text-4xl pb-5 text-slate-50 font-black dark:text-white heading-font">
  My Services</h2>
  <div className="w-full border dark:border-white	border-slate-50 rounded-lg p-5">
